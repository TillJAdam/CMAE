...
# Note to reviewrs: 
This code is for the purposes of peer review. 
Please note that this code is running on simulated data. 
Hence, the results will not match with the results in the manuscript submitted to Nature Mental Health.
...
Table 3 analyses - Body composition-adjuted
```{r, warning=FALSE}
groups <- list(
  "Total" = SATIETY_long,
...
Table 4 analyses - Body composition-dependent
```{r, warning=FALSE}
